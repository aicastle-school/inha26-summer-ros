...
SD 카드 또는 SSD가 인식되지 않거나 손상된 경우 대처하는 방법을 설명합니다.


## 1. SD 카드 손상시 증상````markdown
# Limo 이미지 버전 및 업데이트 가이드
...
3. LiDAR 캐노피 제거
4. Limo 상판 제거
5. Jetson Orin Nano 분리
6. SD 카드 분리
7. SD 카드를 Windows PC에 연결
8. SD Card Formatter로 SD 카드 포맷
9. Rufus로 Limo Pro 이미지 쓰기
10. SD 카드 재장착
11. Limo 재조립
12. 부팅 확인
```
...
1. 아래 화면에서 F11 연타 후 boot manager 접속

    <img src="images/image18.png" width="600">

1. 부팅 순서 변경(2번째 KINGBANK KP230 ~ 선택 후 부팅)
...
1. 자신의 작업 폴더 백업(home/ros1/catkin_ws/src) - 본인이 작업한 패키지
...
1. 나와있는 분리 방법으로 분해 후 SD 카드 분리

    <img src="images/image24.png" width="600">

1. SD 카드 이미지 다운(limo_image_1_0_4.img.gz)
